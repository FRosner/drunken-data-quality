...
class CheckTest extends FlatSpec with Matchers with BeforeAndAfterEach with BeforeAndAfterAll with MockitoSugar {
  ...
  "A joinable check" should "succeed if a join on the given column yields at least one row" in {
    ...
    val constraint = check.constraints.head
    val result = ConstraintSuccess("Column column->column can be used for joining (number of distinct rows in base table: 3, number of distinct rows after joining: 2, unmatched keys in base table: 67%)")
    check.run().constraintResults shouldBe Map(constraint -> result)
  }
  ...
  it should "succeed if a join on the given columns yields at least one row" in {
    ...
    val constraint = check.constraints.head
    val result = ConstraintSuccess("Columns column1->column1, column2->column2 can be used for joining (number of distinct rows in base table: 2, number of distinct rows after joining: 1, unmatched keys in base table: 50%)")
    check.run().constraintResults shouldBe Map(constraint -> result)
  }
  ...
  it should "succeed if a join on the given columns yields at least one row if the columns have a different name" in {
    ...
    val constraint = check.constraints.head
    val result = ConstraintSuccess("Columns column1->column1, column3->column2 can be used for joining (number of distinct rows in base table: 2, number of distinct rows after joining: 1, unmatched keys in base table: 50%)")
    check.run().constraintResults shouldBe Map(constraint -> result)
  }
  ...
  it should "compute the unmatched keys in base table correctly" in {
    ...
    val result1 = ConstraintSuccess("Column column->column can be used for joining (number of distinct rows in base table: 2, number of distinct rows after joining: 1, unmatched keys in base table: 50%)")
    ...
    val result2 = ConstraintSuccess("Column column->column can be used for joining (number of distinct rows in base table: 1, number of distinct rows after joining: 1, unmatched keys in base table: 100%)")
